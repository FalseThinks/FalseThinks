...
![OPC UA](https://img.shields.io/badge/OPC%20UA-003A8F?style=flat&logo=opcua&logoColor=white)

---

## 📂 Highlighted Projects

- **Wasserfilter** — University thesis  
  Microcontroller-based system with MQTT & HTTP communication  
  *Rust, Tauri, MongoDB, Jenkins*

- **IoT Lamp Project**  
  Remote LED control using MQTT  
  🔗 https://github.com/FalseThinks/IOT_LAMP_PROJECT

- **Timesheet Validator Tool (EDAG)**  
  Internal validation system with custom algorithms  
  *C#, React, Docker, PostgreSQL*

- **Shift Planning Tool (EDAG)**  
...
- 📧 Email: alarcon590@gmail.com  
- 💼 LinkedIn: https://www.linkedin.com/in/pablo-ac  
- 🧑‍💻 GitHub: https://github.com/FalseThinks
